...
- Add an explicit modern verification gate backed by an ephemeral Minecraft server bootstrap that verifies FTB Industrial Contraptions, Core, and Generators load together.
