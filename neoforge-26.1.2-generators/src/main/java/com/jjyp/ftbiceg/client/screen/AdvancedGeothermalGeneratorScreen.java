...
public final class AdvancedGeothermalGeneratorScreen extends AbstractContainerScreen<AdvancedGeothermalGeneratorMenu> {
    ...
    protected void extractLabels(GuiGraphicsExtractor graphics, int mouseX, int mouseY) {
        ...
        graphics.text(this.font, Component.translatable(
            "gui.ftbiceg.lava", this.menu.getFluidAmount(), this.menu.getTankCapacity()
        ), 8, 30, TEXT, false);
        graphics.text(this.font, Component.translatable("gui.ftbiceg.battery_slot"), 104, 50, TEXT, false);
        graphics.text(this.font, Component.translatable("gui.ftbiceg.lava_hint"), 8, 61, TEXT, false);
    }
